        ...
        <div class="container">
            <div class="row align-items-center  flex-row-reverse">
                ...
                <div class="px-5 col-lg-6 d-flex flex-column align-items-start justify-content-center order-1 order-lg-2 ">
                    ...
                    <p class="mt-4">Lorem orci elementum dictum viverra sed lobortis <br>vitae purus. Vitae eget cursus
                        dictum ac
        ...
        <div class="container ">
            <div class="row ">
                ...
                <div class="mx-auto col-md-6 p-4 bg-dark-2">
                    ...
                    <p class="mb-1 text-light">Suspendisse morbi mauris gravida tellus integer</p>
                        @session('success')
